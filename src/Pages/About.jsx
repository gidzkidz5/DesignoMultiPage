    ...
    return (
        ...
        <div className="about-card-child flex right">
            ...
            <div className="about-text-container ff-sanserif bg-lightpeach">
                ...
                <h2 className="fs-body font-black">We are a crew of strategists, problem-solvers, and technologists. Every design is thoughtfully crafted from concept to launch, ensuring success in its given market. We are constantly updating our skills in a myriad of platforms.
